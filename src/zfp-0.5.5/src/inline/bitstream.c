...
struct _bs_namespace_struct bsns = {

    .stream_data = stream_data,
    .stream_size = stream_size,
    .stream_capacity = stream_capacity,
    .stream_stride_block = stream_stride_block,
    .stream_stride_delta = stream_stride_delta,
    .stream_read_bit = stream_read_bit,
    .stream_write_bit = stream_write_bit,
    .stream_read_bits = stream_read_bits,
    .stream_write_bits = stream_write_bits,
    .stream_rtell = stream_rtell,
    .stream_wtell = stream_wtell,
    .stream_rewind = stream_rewind,
    .stream_rseek = stream_rseek,
    .stream_wseek = stream_wseek,
    .stream_skip = stream_skip,
    .stream_pad = stream_pad,
    .stream_align = stream_align,
    .stream_flush = stream_flush,
    .stream_copy = stream_copy,
    .stream_open = stream_open,
    .stream_close = stream_close,
    .stream_clone = stream_clone,
    .stream_word_bits = wsize
