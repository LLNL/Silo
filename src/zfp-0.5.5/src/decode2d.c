...
void zfp_init_decode2d() {
 zfpns.zfp_decode_block_double_2 = zfp_decode_block_double_2;
 zfpns.zfp_decode_block_strided_double_2 = zfp_decode_block_strided_double_2;
 zfpns.zfp_decode_partial_block_strided_double_2 = zfp_decode_partial_block_strided_double_2;
}
