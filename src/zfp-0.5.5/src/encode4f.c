...
void zfp_init_encode4f() {
 zfpns.zfp_encode_block_float_4 = zfp_encode_block_float_4;
 zfpns.zfp_encode_block_strided_float_4 = zfp_encode_block_strided_float_4;
 zfpns.zfp_encode_partial_block_strided_float_4 = zfp_encode_partial_block_strided_float_4;
}
