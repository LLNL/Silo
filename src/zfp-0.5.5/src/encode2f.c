...
void zfp_init_encode2f() {
 zfpns.zfp_encode_block_float_2 = zfp_encode_block_float_2;
 zfpns.zfp_encode_block_strided_float_2 = zfp_encode_block_strided_float_2;
 zfpns.zfp_encode_partial_block_strided_float_2 = zfp_encode_partial_block_strided_float_2;
}
