...
void zfp_init_decode3d() {
 zfpns.zfp_decode_block_double_3 = zfp_decode_block_double_3;
 zfpns.zfp_decode_block_strided_double_3 = zfp_decode_block_strided_double_3;
 zfpns.zfp_decode_partial_block_strided_double_3 = zfp_decode_partial_block_strided_double_3;
}
