...
&nbsp;|&nbsp;|&nbsp;
:---|:---|:---
[`<DBfile>.Close`](#<dbfile>.close)|[`<DBfile>.GetToc`](#<dbfile>.gettoc)|[`<DBfile>.GetVar`](#<dbfile>.getvar)
[`<DBfile>.GetVarInfo`](#<dbfile>.getvarinfo)|[`<DBfile>.MkDir`](#<dbfile>.mkdir)|[`<DBfile>.SetDir`](#<dbfile>.setdir)
[`<DBfile>.Write`](#<dbfile>.write)|[`<DBfile>.WriteObject`](#<dbfile>.writeobject)|[`Silo.Create`](#silo.create)
[`Silo.Open`](#silo.open)|
